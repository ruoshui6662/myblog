...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '若水的小站',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '若水', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '疯人疯言', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rs666.top', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '若水', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
